...
import 'package:starbucks/coba.dart';
import 'package:starbucks/detail_kopi.dart';
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Detail_kopi(
                                    datakopi: dataKopi[index],
                                  )));
                    },
                    child: Card(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image:
                                              AssetImage(dataKopi[index].image),
                                          fit: BoxFit.cover)),
                                ),
                              ),
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Rp.' + dataKopi[index].price,
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color:
                                              Color.fromARGB(255, 13, 155, 0)),
                                    )
                                  ],
                                ),
                              )
